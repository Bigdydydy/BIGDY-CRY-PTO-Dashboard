...
- **恒定到期基差曲线 (Constant Maturity Basis)**：拟合 7D / 30D / 60D / 90D / 180D 年化基差（Annualized Basis）。
- **资本成本基准对标**：内置 **8.0% 机构资本机会成本基准线** 与 **4.5% 美债无风险利率基准**，精准识别基差溢价扩张（Carry Trade 结构性套利窗口）与深度倒挂（极度避险去杠杆）。
